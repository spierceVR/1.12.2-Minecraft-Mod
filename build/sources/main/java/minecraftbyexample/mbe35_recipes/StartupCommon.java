...
public class StartupCommon
{
  ...
  public static void initCommon()
  {
    ...
    IRecipe saplingRecipe = new ShapedOreRecipe(optionalGroup,
            new ItemStack(minecraftbyexample.my_tool.StartupCommon.myTool), new Object[] {
            "SSS",
            " L ",
            " L ",
            'S', new ItemStack(minecraftbyexample.block_my.StartupCommon.blockMy, 64),   // can use ordinary items, blocks, itemstacks in ShapedOreRecipe
