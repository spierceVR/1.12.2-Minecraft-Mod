...
public class ClientOnlyProxy extends CommonProxy
{
  ...
  {
    super.preInit();
    minecraftbyexample.my_entity.StartupClientOnly.preInitClientOnly();
    minecraftbyexample.mbe70_configuration.StartupClientOnly.preInitClientOnly();
    minecraftbyexample.armor.StartupClientOnly.preInitClientOnly();
    minecraftbyexample.my_tool.StartupClientOnly.preInitClientOnly();
    minecraftbyexample.block_my.StartupClientOnly.preInitClientOnly();
    ...
    minecraftbyexample.mbe07_block_behavior.StartupClientOnly.preInitClientOnly();
    minecraftbyexample.mbe08_creative_tab.StartupClientOnly.preInitClientOnly();
    minecraftbyexample.mbe09_ore_spawning.StartupClientOnly.preInitClientOnly();
    minecraftbyexample.mbe10_item_simple.StartupClientOnly.preInitClientOnly();
    minecraftbyexample.mbe10_tool_simple.StartupClientOnly.preInitClientOnly();
    ...
    minecraftbyexample.mbe16_item_food.StartupClientOnly.preInitClientOnly();
  ...
  public void init()
  {
    ...
    minecraftbyexample.my_tool.StartupClientOnly.initClientOnly();
    minecraftbyexample.my_entity.StartupClientOnly.initClientOnly();
    minecraftbyexample.armor.StartupClientOnly.initClientOnly();
    minecraftbyexample.block_my.StartupClientOnly.initClientOnly();
    ...
    minecraftbyexample.mbe07_block_behavior.StartupClientOnly.initClientOnly();
    minecraftbyexample.mbe08_creative_tab.StartupClientOnly.initClientOnly();
    minecraftbyexample.mbe09_ore_spawning.StartupClientOnly.initClientOnly();
    minecraftbyexample.mbe10_item_simple.StartupClientOnly.initClientOnly();
    minecraftbyexample.mbe10_tool_simple.StartupClientOnly.initClientOnly();
    ...
    minecraftbyexample.mbe16_item_food.StartupClientOnly.initClientOnly();
  ...
  public void postInit()
  {
    ...
    minecraftbyexample.my_tool.StartupClientOnly.postInitClientOnly();
    minecraftbyexample.my_entity.StartupClientOnly.postInitClientOnly();
    minecraftbyexample.armor.StartupClientOnly.postInitClientOnly();
    minecraftbyexample.block_my.StartupClientOnly.postInitClientOnly();
    ...
    minecraftbyexample.mbe07_block_behavior.StartupClientOnly.postInitClientOnly();
    minecraftbyexample.mbe08_creative_tab.StartupClientOnly.postInitClientOnly();
    minecraftbyexample.mbe09_ore_spawning.StartupClientOnly.postInitClientOnly();
    minecraftbyexample.mbe10_item_simple.StartupClientOnly.postInitClientOnly();
    minecraftbyexample.mbe10_tool_simple.StartupClientOnly.postInitClientOnly();
